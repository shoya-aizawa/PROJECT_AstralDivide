...
echo %esc%[93m   ===========================================   %esc%[0m
echo.
echo %esc%[97m                Press any key...                 %esc%[0m
pause >nul
...
:Run_Compatibility_Test
    ...
    echo !esc![93m    Check that the entire frame is displayed correctly (30 seconds)!esc![0m
    echo.
