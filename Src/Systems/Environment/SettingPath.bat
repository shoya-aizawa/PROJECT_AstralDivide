...
set "src_stories_dir=%src_dir%\Stories"
   set "src_scenes_dir=%src_stories_dir%\Scenes"
      ...
      set "src_scene_chapter01_dir=%src_scenes_dir%\01_Chapter01"
   ...
   set "src_textassets_dir=%src_stories_dir%\TextAssets"
      ...
      set "src_text_chapter01_dir=%src_textassets_dir%\01_Chapter01"
...
endlocal & (
  ...
  set "src_scene_chapter01_dir=%src_scene_chapter01_dir%"
  set "src_textassets_dir=%src_textassets_dir%"
  set "src_text_newgame_dir=%src_text_newgame_dir%"
  set "src_text_chapter01_dir=%src_text_chapter01_dir%"
